  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-[#FF4B4B]">
      <div className="flex-1">
        <div className={`hero bg-[#FF4B4B] flex flex-col justify-center items-center text-center py-10 ${animationClass}`}>
        ...
        <div className={`w-[80vw] mx-auto bg-white p-6 rounded-lg shadow-[0_0_12px_rgba(0,0,0,0.40)] border border-gray-400 ${animationClass}`}>
